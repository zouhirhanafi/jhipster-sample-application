...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './parameter.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_PARAMETER_LIST actions', async () => {
    ...
    it('dispatches FETCH_PARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_PARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_PARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_PARAMETER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_PARAMETER actions', async () => {
      const expectedActions = [
        {
