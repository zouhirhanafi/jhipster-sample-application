...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './conteneur.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTENEUR_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTENEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTENEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTENEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTENEUR actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTENEUR actions', async () => {
      const expectedActions = [
        {
